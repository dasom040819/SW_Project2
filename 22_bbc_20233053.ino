...
#define _DUTY_NEU 1460 // 1500
#define _DUTY_MIN 600 // 1000

#define _SERVO_ANGLE_DIFF  14  // Replace with |D :25- E:11| degree
...
float volt_to_distance(int a_value)
{
  ...
  return 1082 + (-5.86)*a_value + 0.0113*a_value*a_value-7.49E-06*pow(a_value,3);
